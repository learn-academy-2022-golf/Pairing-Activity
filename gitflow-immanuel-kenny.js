...
## Clone down the repository 
  - Navigate to gitHub, click on Learn Academy 2002 Golf
- Click repo, then click pairing activity. 
- Mid upper right corner, click green code box.
- Copy https URL 
- Navigate to terminal and then type git clone and paste URL
- ls to see if copied or cloned correctly.
